/**
 * The product's name in one place, so a rename is one edit rather than a
 * grep across every page title, heading and email subject.
 */
 ...
 *
 * Identical to PRODUCT_NAME today, and deliberately separate: the wordmark is
